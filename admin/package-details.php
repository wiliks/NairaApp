        ...
        <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
              ...
              <li> <a href="#" class="waves-effect active"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Blog<span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="new_package.php">Create new Package</a></li>
                    ...
                    <div class="white-box">
                        <div class="row">
                            ...
                            <?php 
                                ...
                                $sql="SELECT * FROM package WHERE id='$postid'";

                                 $query = mysqli_query($connection, $sql);
                                    while ($row = mysqli_fetch_assoc($query)) {
                                        $postid = $row["ID"];
                                               // $sql2 = "SELECT * FROM package WHERE ID=$postid";
                            ...
                            '<div class="col-lg-12 col-md-9 col-sm-8 col-xs-12 mail_listing">
                                <div class="media m-b-30 p-t-20">
                                    ...
                                    <i style="float:right; font-size:15px; color:orange;">Item(s): '.'1'.'</i>
                                    </h4>
                                    <hr>
                                    <a class="pull-left" href="#"></a>
                                    <div class="media-body"> <span class="media-meta pull-right">'.$row["ID"].'</span>
                                        <h4 class="text-danger m-0">'.$row["ID"].'</h4></div>
                                </div>
                                <p>'.$row["location"].'</p>
                                <hr>
                                <div class="b-all p-20">
                                   <a href="#" style="color:green;" class="btn btn-default btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light" data-toggle="modal" data-target="#responsive-modal'.$row["ID"].'">CHANGE LOCATION</a>
                                   <a href="#" class="btn btn-danger btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light" data-toggle="modal" data-target="#responsive-modal2'.$row["ID"].'">DELETE PACKAGE</a>
                                </div>
                            </div>
                            ...
                            <!-- /.modal -->
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title">Ente new Location</h4></div>
                                                    <div class="modal-footer">
                                                    <form action="functions/change_location.php" method="post">
                                                    <input  name="ID" value="'.$row["ID"].'"/>
                                                    <input  name="name" value="'.$row["name"].'"/>
                                                    <input  name="location" placeholder="current location" value="'.$row["location"].'"/>
                                                    
                                                    <input placeholder="map adrress"  name="maplocation" value="'.$row["maplocation"].'"/>
                                        ...
                                        <!-- End Modal -->
                                        <!-- /.modal -->
                                            <div id="responsive-modal2'.$row["ID"].'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h4 class="modal-title">Are you sure you want to delete this package?</h4></div>
                                                        <div class="modal-footer">
                                                        <form action="functions/del_package.php" method="post">
