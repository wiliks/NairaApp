...
<?php
    ...
    $query_package = mysqli_query($connection, $sql_package);
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <h4 class="page-title"><?php echo $row["namez"]; ?></h4><a href="#"><i data-toggle="modal" data-target="#responsive-modal" title="remove" style="color:red;">edit</i></a> </div>
                         <!-- /.modal -->
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title">Enter new site name</h4></div>
                                                        <div class="modal-footer">
                                                        <form action="functions/changename.php" method="post">
                                                        <input type="text" name="name"  placeholder="new site name" value=""/>
                ...
                <?php
                                    ...
                                    elseif (isset($_GET["deleted"])) {
                                        ...
                                        '<div class="alert alert-warning" >
                                              <a href="#" class="close" data-dismiss="alert" aria-label="close"></a>
                                             <strong>CHANGED!!! </strong><p> The Site name has been successfully changed.</p>
                                        </div>'
                                        ;
                                    }
                                    elseif (isset($_GET["del_error"])) {
                                        ...
                                        '<div class="alert alert-danger" >
                                              <a href="#" class="close" data-dismiss="alert" aria-label="close"></a>
                                             <strong>ERROR!! </strong><p> There was an error during the change. Please try again.</p>
                                        </div>'
                                        ;
                                    }
								?>	
                                ...
                                <div class="col-lg-3 col-sm-6 row-in-br">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                            <h5 class="text-muted vb">Number of packages</h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="<?php if(mysqli_num_rows($query_package)>50){echo "counter text-right m-t-15 text-danger";}else{echo "counter text-right m-t-15 text-megna";} ?>"><?php echo mysqli_num_rows($query_package);?></h3> </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="progress">
                                                <div class="<?php if(mysqli_num_rows($query_package)>50){echo "progress-bar progress-bar-danger";}else{echo "progress-bar progress-bar-megna";} ?>"><?php echo mysqli_num_rows($query_package);?>" role="progressbar" aria-valuenow="<?php echo mysqli_num_rows($query_package);?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo mysqli_num_rows($query_package);?>%"> <span class="sr-only">40% Complete (success)</span> </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
