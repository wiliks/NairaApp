          ...
          <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                 ...
                 <li> <a href="#" class="waves-effect active"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Blog<span class="fa arrow"></span></span></a>
                     <ul class="nav nav-second-level">
                          ...
                          <li><a href="new_package.php">Create Package</a></li>
                                  ...
                                  <div class="inbox-center">
                                          <?php  
                                                          if (isset($_GET['posted'])) {
                                                              echo'<div class="alert alert-success" >
                                                                 ...
                                                                 <strong>DONE!! </strong><p> Your new package has been successfully uploaded.</p>
                                                                 </div>';
                                                          }    
                                                      ...
                                                      elseif (isset($_GET["deleted"])) {
                                                        ...
                                                        '<div class="alert alert-danger" >
                                                              <a href="#" class="close" data-dismiss="alert" aria-label="close"></a>
                                                             <strong>DELETED!!! </strong><p> Package has been deleted</p>
                                                        </div>'
                                                        ;   
                                                      }                                                    
                                                      ?>
                                      <table class="table table-hover">
                                          ...
                                          <thead>
                                              <tr>
                                                  <th>
                                                      <h4>Recent Packages (<b style="color: orange;"><?php echo mysqli_num_rows($query);?></b>)</h4>
                                                      <?php 
                                          ...
                                          <tbody>
                                           <?php
                                            ...
                                            echo
                                            '<tr>
                                                  <td class="hidden-xs"><a href="package-details.php?ID='.$row["ID"].'" />'.$row["name"].'</td>
                                                  <td class="max-texts"> <a href="package-details.php?ID='.$row["ID"].'" />'.$row["location"].'</td>
                                                  </td>
