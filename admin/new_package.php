    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Create New Package</h3>
                        <p class="text-muted m-b-30 font-13"> A package contains the ID, Name,First Location,Current Location, map address and its Destination.</p>
                        <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="functions/new_package.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="Package name" required/> </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <input type="text" id="id" class="form-control" name="ID" ></input> </div><button onClick="generate()">Generate</button>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-marker"></i></div>
                                                <input type="text" class="form-control" name="firstlocation" placeholder="First Location" required > </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-marker"></i></div>
                                                <input class="form-control" name="location" placeholder="Current Location" required > </div>
                                                <div id="msg" style="padding-left: 10px;"></div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-marker"></i></div>
                                                <input class="form-control" name="maplocation"  placeholder="Map Address" required > </div>
                                                <div id="msg" style="padding-left: 10px;"></div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-marker"></i></div>
                                                <input class="form-control" name="destination"  placeholder="Package Destination" required > </div>
                                                <div id="msg" style="padding-left: 10px;"></div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="submit" name="submit" class="btn btn-success waves-effect waves-light m-r-10"/>
                                    </form>
                                </div>
                             </div>
                    </div>
...
<script>
    function generate(){
        var a =Math.floor(100000000000 + Math.random() * 900000000000);
